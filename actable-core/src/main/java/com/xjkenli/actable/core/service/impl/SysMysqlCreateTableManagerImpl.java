package com.xjkenli.actable.core.service.impl;

import com.baomidou.mybatisplus.annotation.TableName;
import com.xjkenli.actable.api.annotation.IgnoreUpdate;
import com.xjkenli.actable.api.annotation.Index;
import com.xjkenli.actable.api.annotation.Table;
import com.xjkenli.actable.api.annotation.Unique;
import com.xjkenli.actable.api.constants.Constants;
...
import com.xjkenli.actable.api.constants.MySqlTypeConstant;
import com.xjkenli.actable.core.mapper.CreateMysqlTablesMapper;
import com.xjkenli.actable.api.model.CreateTableParam;
import com.xjkenli.actable.api.model.MySqlTypeAndLength;
import com.xjkenli.actable.api.model.TableConfig;
import com.xjkenli.actable.api.model.mysql.SysMysqlColumns;
import com.xjkenli.actable.api.model.mysql.SysMysqlTable;
import com.xjkenli.actable.core.service.SysMysqlCreateTableManager;
import com.xjkenli.actable.api.utils.ClassScaner;
import com.xjkenli.actable.api.utils.ClassTools;
import com.xjkenli.actable.api.utils.ColumnUtils;
import com.xjkenli.actable.api.utils.ConfigurationUtil;
		...
		for (SysMysqlColumns sysColumn : tableColumnList) {
			...
			if (createTableParam != null && !createTableParam.getIgnoreUpdate()) {
				...
				if (createTableParam.getFileTypeLength() == 1) {
                    ...
                    if (!typeAndLength.equals("bigint")){
		...
		if (dropIndexAndUniqueMap.size() > 0) {
			for (Entry<String, TableConfig> entry : dropIndexAndUniqueMap.entrySet()) {
				for (Object obj : entry.getValue().getList()) {
					...
					createMysqlTablesMapper.dropTableIndex(map);
