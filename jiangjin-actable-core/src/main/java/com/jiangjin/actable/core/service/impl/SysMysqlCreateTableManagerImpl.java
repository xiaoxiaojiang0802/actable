...
import com.jiangjin.actable.api.annotation.IgnoreUpdate;
import com.jiangjin.actable.api.annotation.Index;
import com.jiangjin.actable.api.annotation.Table;
import com.jiangjin.actable.api.annotation.Unique;
...
import com.jiangjin.actable.api.model.CreateTableParam;
import com.jiangjin.actable.api.model.MySqlTypeAndLength;
...
import com.jiangjin.actable.api.utils.ClassScaner;
import com.jiangjin.actable.api.utils.ClassTools;
    ...
    public List<Object> getAllFields(Class<?> clas) {
        ...
        for (Field field : fields) {
            ...
            if (ColumnUtils.hasColumnAnnotation(field, clas)) {
                ...
                param.setFieldDefaultValueNative(ColumnUtils.getDefaultValueNative(field));
